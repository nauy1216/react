...
(function(){(function (global, factory) {
  ...
  const chunkCache = new Map(); // Start preloading the modules since we might need them soon.
  ...
  function resolveModule(response, id, model) {
    ...
    const moduleReference = resolveModuleReference(moduleMetaData); // TODO: Add an option to encode modules that are lazy loaded.
