...
(function(){(function (global, factory) {
  ...
  const isSchedulerMocked = typeof unstable_flushAllWithoutAsserting === 'function';

  const flushWork = unstable_flushAllWithoutAsserting || function () {
  ...
  function flushActWork(resolve, reject) {
    ...
    enqueueTask(() => {
      try {
        const didFlushWork = unstable_flushAllWithoutAsserting();
  ...
  function validateClassInstance(inst, methodName) {
    ...
    {
      {
        throw Error( formatProdErrorMessage(286, methodName, received));
      }
    }
  }
  /**
  ...
  function makeSimulator(eventType) {
    return function (domNode, eventData) {
      if (!!React.isValidElement(domNode)) {
        {
          throw Error( formatProdErrorMessage(228));
        }
      }

      if (!!isCompositeComponent(domNode)) {
        {
          throw Error( formatProdErrorMessage(229));
        }
      }
