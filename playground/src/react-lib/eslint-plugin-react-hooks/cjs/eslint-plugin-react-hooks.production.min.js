            ...
            try {
              for (_iterator8.s(); !(_step8 = _iterator8.n()).done;) {
                ...
                if (isDirectlyInsideComponentOrHook) {
                  ...
                  const message = "React Hook \"" + context.getSource(hook) + "\" is called in " + ("function \"" + context.getSource(codePathFunctionName) + "\" ") + 'that is neither a React function component nor a custom ' + 'React Hook function.' + ' React component names must start with an uppercase letter.';
                  context.report({
                    node: hook,
                    message
                  });
...
var ExhaustiveDeps = {
  ...
  create(context) {
    ...
    function visitFunctionWithDependencies(node, declaredDependenciesNode, reactiveHook, reactiveHookName, isEffect) {
      ...
      const memoizedIsStablecKnownHookValue = memoizeWithWeakMap(isStableKnownHookValue, stableKnownValueCache);
        ...
        try {
          for (_iterator.s(); !(_step = _iterator.n()).done;) {
            ...
            if (!dependencies.has(dependency)) {
              ...
              const isStable = memoizedIsStablecKnownHookValue(resolved) || memoizedIsFunctionWithoutCapturedValues(resolved);
    ...
    function visitCallExpression(node) {
      ...
      const isEffect = /Effect($|[^a-z])/g.test(reactiveHookName); // Check the declared dependencies for this reactive hook. If there is no
